...
export default function HomeScreen({ navigation }) {
  ...
  // ✅ Función corregida para obtener el nombre de pila
  const getNombreSaludo = () => {
    ...
    if (paciente.nombre) {
      // Si tiene nombre completo con espacios, tomar solo el primer nombre
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        {/* ✅ Saludo según la hora del día (debajo, con separación) */}
          ...
          >
            <View style={styles.citaCardTop}>
              ...
              <View style={styles.citaBadge}>
                <Text style={styles.citaBadgeText}>Confirmada</Text>
              </View>
            </View>
            <Text style={styles.citaEspecialidad}>{proximaCita.especialidad || 'Consulta General'}</Text>
            <Text style={styles.citaMedico}>Dr. {proximaCita.medico || 'Médico asignado'}</Text>
        ...
        >
          <View style={styles.mensajesLeft}>
            <Text style={styles.mensajesIcon}>✉️</Text>
            <Text style={styles.mensajesLabel}>Mensajes</Text>
          </View>
          {mensajesNoLeidos > 0 && (
...
const styles = StyleSheet.create({
  ...
  avatarButton: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#1A6B5A', alignItems: 'center', justifyContent: 'center' },
  ...
  greetingName: { fontSize: 28, fontWeight: '800', color: '#111827', marginTop: 4 },
  greetingSubtitle: { fontSize: 14, color: '#6B7280', marginTop: 4, marginBottom: 16 },
  reminderCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#EBF5FF', borderRadius: 14, padding: 14, marginBottom: 4 },
  reminderIconWrapper: { width: 38, height: 38, borderRadius: 10, backgroundColor: '#DBEAFE', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  reminderIcon: { fontSize: 18 },
  reminderTextWrapper: { flex: 1 },
  reminderLabel: { fontSize: 11, fontWeight: '600', color: '#3B82F6', marginBottom: 2 },
  reminderValue: { fontSize: 14, fontWeight: '600', color: '#1D4ED8' },
  citaCard: { backgroundColor: '#1A6B5A', borderRadius: 18, padding: 20 },
  citaCardTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  citaIconWrapper: { width: 40, height: 40, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.15)', alignItems: 'center', justifyContent: 'center' },
  citaIcon: { fontSize: 20 },
  citaBadge: { backgroundColor: 'rgba(255,255,255,0.25)', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4 },
  citaBadgeText: { fontSize: 12, color: '#FFFFFF', fontWeight: '600' },
  citaEspecialidad: { fontSize: 22, fontWeight: '800', color: '#FFFFFF', marginBottom: 4 },
  citaMedico: { fontSize: 14, color: 'rgba(255,255,255,0.8)', marginBottom: 14 },
  citaFechaRow: { flexDirection: 'row', alignItems: 'center' },
  citaFechaIcon: { fontSize: 14, marginRight: 6 },
  citaFecha: { fontSize: 14, color: 'rgba(255,255,255,0.9)', fontWeight: '500', flex: 1 },
  citaArrow: { fontSize: 18, color: '#FFFFFF', fontWeight: '700' },
  noCitaCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 20, alignItems: 'center', borderWidth: 1, borderColor: '#E5E7EB', borderStyle: 'dashed' },
  noCitaText: { fontSize: 14, color: '#6B7280', marginBottom: 8 },
  noCitaLink: { fontSize: 14, color: '#1A6B5A', fontWeight: '700' },
  quickAccessRow: { flexDirection: 'row', gap: 12, marginBottom: 12 },
  quickCard: { flex: 1, backgroundColor: '#FFFFFF', borderRadius: 14, paddingVertical: 20, alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
  quickCardIcon: { fontSize: 24, marginBottom: 6 },
  quickCardLabel: { fontSize: 13, fontWeight: '600', color: '#374151' },
  mensajesCard: { backgroundColor: '#FFFFFF', borderRadius: 14, paddingVertical: 18, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
  mensajesLeft: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  mensajesIcon: { fontSize: 22 },
  mensajesLabel: { fontSize: 14, fontWeight: '600', color: '#374151' },
  ...
  indicadorCard: { backgroundColor: '#FFFFFF', borderRadius: 14, padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
  indicadorLeft: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  indicadorIcon: { fontSize: 22 },
  indicadorNombre: { fontSize: 12, color: '#6B7280', fontWeight: '500', marginBottom: 2 },
  indicadorValor: { fontSize: 16, fontWeight: '700', color: '#111827' },
  indicadorBadge: { backgroundColor: '#D1FAE5', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4 },
  indicadorBadgeText: { fontSize: 12, color: '#065F46', fontWeight: '600' },
